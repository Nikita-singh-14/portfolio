...
const LocationMap = () => {
    ...
    const position = [22.1287782, 82.1377255]; 
    const initialZoom = 14; // Zoom level adjusted to show the university campus clearly
        ...
        <div className="flex-[2] bg-gray-200 rounded-xl shadow-inner border border-gray-300 overflow-hidden">
            ...
            >
                ...
                <Marker position={position}>
                    <Popup>
                        **Guru Ghasidas Vishwavidyalaya**, <br /> Bilaspur, Chhattisgarh.
                    </Popup>
                </Marker>
            </MapContainer>
        </div>
                ...
                <div className=" flex flex-col md:flex-row gap-16">
                    ...
                    <form className="flex-1 space-y-6">
                        ...
                        <div>
                            <button
                                type="submit"
                                // The 'status' variable must be defined (e.g., using useState) for this line to work in a real app
                                disabled={status === 'Sending...'} 
                                className="w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-xl shadow-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300 transform hover:scale-[1.01] disabled:bg-blue-400"
                            >
