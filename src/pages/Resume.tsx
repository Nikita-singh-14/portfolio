    ...
    <div id={id} className='about flex flex-col gap-10 w-full'>
            <div >
             ...
             <div className='flex flex-col items-center  gap-10'>
                <div className="font-['Inter'] min-h-screen bg-gray-50 p-4 sm:p-8">
      {/* Load Tailwind CSS from CDN - assumed to be available in this environment */}
      <script src="https://cdn.tailwindcss.com"></script> 
      
      <div className="max-w-4xl mx-auto bg-white shadow-2xl rounded-lg p-6 sm:p-10 border border-gray-200">
